    ...
    <footer id="footer" class="footer color-bg">
        <div class="footer-bottom nav-color-mix">
            <div class="container">
                <div class="row">
                        ...
                        <div class="module-body">
                            <ul>
                                ...
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        <p style="padding-top: 10px;">info@angelscreativity.com</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="col-xs-12 col-sm-6 no-padding">
                    <div class="clearfix payment-methods">
                        <ul>
                            ...
                            <li><img src="{{ asset('assets/images/payments/momo.png') }}" style="width: 45px; height:28px;"></li>
                        </ul>
                    </div>
                    <!-- /.payment-methods -->
                </div>
